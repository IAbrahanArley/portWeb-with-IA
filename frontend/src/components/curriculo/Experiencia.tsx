...
const Experiencia = () => {
	return (
		<div className="flex flex-col md:flex-row lg:flex-col gap-6 items-center justify-around bg-black border p-6 border-zinc-800 ">
...
function Item(props: { principal: string; label: string }) {
	return (
		<div className="flex flex-col items-center">
			...
			<span className="text-zinc-400 text-sm text-center mt-2     ">{props.label}</span>
		</div>
	)
}
